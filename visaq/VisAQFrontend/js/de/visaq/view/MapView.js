...
(function (de) {
    ...
    (function (visaq) {
        ...
        (function (view) {
             ...
             */
            class MapView extends de.visaq.view.View {
                constructor(map, airQualityData) {
                    super();
                    if (this.map === undefined)
                        this.map = null;
                    if (this.airqualityData === undefined)
                        this.airqualityData = null;
                    if (this.overlayBuilder === undefined)
                        this.overlayBuilder = null;
                    if (this.overlayFactories === undefined)
                        this.overlayFactories = null;
                    if (this.layers === undefined)
                        this.layers = null;
                    if (this.legend === undefined)
                        this.legend = null;
                    if (this.sensorOverview === undefined)
                        this.sensorOverview = null;
                    if (this.searchBar === undefined)
                        this.searchBar = null;
                    if (this.currentAirQualityData === undefined)
                        this.currentAirQualityData = null;
                    if (this.expertView === undefined)
                        this.expertView = false;
                    if (this.expertViewFilter === undefined)
                        this.expertViewFilter = null;
                    if (this.historicalView === undefined)
                        this.historicalView = false;
                    ...
                    this.layers = ([]);
                    this.overlayFactories = ([]);
                    let sensorOverlayFactory = new de.visaq.view.overlay.factory.SensorOverlayFactory();
                    let interpolationOverlayFactory = new de.visaq.view.overlay.factory.InterpolationOverlayFactory();
                 ...
                 */
                mapDataQueryCoordinates(coordinates) {
